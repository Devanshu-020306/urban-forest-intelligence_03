    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
          ...
          <div className="mt-6 p-4 bg-gray-50 rounded-lg">
            ...
            <div className="space-y-2 text-xs text-gray-500">
              <div className="flex items-start space-x-2">
                ...
                <span>Full access to all features - manage trees, logs, analytics</span>
              </div>
              <div className="flex items-start space-x-2">
                <span className="font-semibold text-blue-600">Visitor:</span>
                <span>AI Disease Detection - Upload photos to detect plant diseases</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <p className="text-center text-sm text-gray-600 mt-6">
          <span className="font-semibold">Visitor Mode:</span> Instant AI-powered disease detection • 
          <span className="font-semibold ml-2">Admin Mode:</span> Full tree management system
        </p>
      </div>
    </div>
  )
